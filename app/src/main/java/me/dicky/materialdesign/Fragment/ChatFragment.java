package me.dicky.materialdesign.Fragment;
...
import me.dicky.materialdesign.Adapter.CustomAdapter;
...
public class ChatFragment extends Fragment {
    ...
    int [] icon = {R.drawable.ic_smile, R.drawable.ic_smile,R.drawable.ic_smile};
